                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('api-userDestroy',$user->id) }}" method="post">
                                                        ...
                                                        <div class="btn-group">
                                                            @can('api-user.edit')
                                                                <a href="{{ route('api-userShow',$user->id) }}" type="button" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                            @endcan
                                                            @can('api-user.edit')
                                                            <a href="{{ route('api-userEdit',$user->id) }}" type="button" class="btn btn-info"><i class="fas fa-pen"></i></a>
                                                            @endcan
