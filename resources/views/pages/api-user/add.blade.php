                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('api-userCreate') }}" method="post">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" placeholder="Имя пользователя" value="{{ old('name') }}" required>
                                @if($errors->has('name'))
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="number" name="token_valid_period" max="999999" min="1" class="form-control {{ $errors->has('token_valid_period') ? 'is-invalid':'' }}" id="token_valid_period" placeholder="Срок действия токена"  value="{{ old('token_valid_period',30) }}">
