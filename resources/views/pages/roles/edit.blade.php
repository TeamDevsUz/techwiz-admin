                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('roleUpdate',$role->id) }}" method="post">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" placeholder="@lang('cruds.role.fields.name')" value="{{ old('name',$role->name) }}" required>
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="@lang('cruds.role.fields.title')" value="{{ old('title',$role->title) }}" required>
                            </fieldset>
