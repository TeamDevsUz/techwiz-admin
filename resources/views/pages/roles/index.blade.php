            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('roles.add')
                        <a href="{{ route('roleAdd') }}" class="btn btn-success waves-effect waves-light float-right">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('roleDestroy',$role->id) }}" method="post">
                                                    ...
                                                    <div class="btn-group">
                                                        @can('roles.edit')
                                                            <a href="{{ route('roleEdit',$role->id) }}" type="button" class="btn btn-info"> @lang('global.edit')</a>
                                                        @endcan
