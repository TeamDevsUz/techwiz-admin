                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('userUpdate',$user->id) }}" method="post">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" placeholder="@lang('cruds.user.fields.name')" value="{{ old('name', $user->name) }}" required>
                                @if($errors->has('name'))
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="email" name="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" placeholder="@lang('cruds.user.fields.email')" value="{{ old('email', $user->email) }}" required>
                                @if($errors->has('email'))
