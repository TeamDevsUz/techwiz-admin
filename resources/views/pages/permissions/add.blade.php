                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('permissionCreate') }}" method="post">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" placeholder="@lang('cruds.permission.fields.name')" value="{{ old('name') }}" required>
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="title" placeholder="@lang('cruds.permission.fields.title')" value="{{ old('title') }}" required>
                            </fieldset>
