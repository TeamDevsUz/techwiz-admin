                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-language nav-item">
                            <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="selected-language">O'zbekcha</span>
                                @else
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                                <a class="dropdown-item" href="{{route('changelang', 'ru')}}" data-language="ru">
                                    <i class="flag-icon flag-icon-ru"></i>
                                    Русский
                                </a>
                                <a class="dropdown-item" href="{{route('changelang', 'uz')}}" data-language="uz">
                                    <i class="flag-icon flag-icon-uz"></i>
                                    O'zbekcha
                                </a>
                            </div>
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                ...
                                <span>
                                    <img class="round" src="{{ asset('app-assets/images/avatar-dafault.png') }}" alt="avatar" height="40" width="40">
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="#" role="button" onclick="
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0">
            <span class="float-md-left d-block d-md-inline-block mt-25">
                Copyright &copy; {{ date('Y') }} <a href="https://t.me/skyzone_admin">Skyzone-Group </a>
                All rights Reserved
            </span>
